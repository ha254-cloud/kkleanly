...
export const PickupReceiptModal: React.FC<PickupReceiptModalProps> = ({
  ...
  // Early return if order is null to prevent crashes
  if (!order) {
    return null;
  }
          ...
          <Card style={styles.receiptCard}>
            ...
            <View style={styles.receiptSection}>
              ...
              <Text style={[styles.serviceType, { color: colors.primary }]}>
                {(order.category || 'service').replace('-', ' ').toUpperCase()} SERVICE
              </Text>
            ...
            <View style={styles.receiptFooter}>
              ...
              <View style={styles.footerDivider}>
                <Text style={[styles.footerText, { color: colors.textSecondary }]}>
                  Receipt #{formatOrderId(order.id)}-{new Date().getTime().toString().slice(-4)}
                </Text>
              </View>
            </View>
          </Card>
