...
export default function OrdersScreen() {
  ...
  useEffect(() => {
    // Real-time listener is now handled by OrderContext
    console.log('📱 Orders screen mounted - real-time updates active');
    // Remove the manual refresh call since real-time handles it
    // refreshOrders();
  }, []);
