// Test password reset email for mainaharry67@gmail.com
...
async function testEmailFlow() {
  const testEmail = 'mainaharry67@gmail.com';
  ...
  try {
    ...
    console.log('📬 Check the inbox for mainaharry67@gmail.com');
...
testEmailFlow().then(() => {
  ...
  console.log('📝 If successful, check mainaharry67@gmail.com for the reset email');
  process.exit(0);
}).catch((error) => {
